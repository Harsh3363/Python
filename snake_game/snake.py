...
class Snake:
    ...
    # below method is responsible for adding new block to the snake ->
    def add_segment(self, position):
        timmy2 = turtle.Turtle("square")
        timmy2.penup()
        timmy2.color("white")
        timmy2.goto(position)
        self.segment.append(timmy2)

    # this below code is responsible for adding new block when snake eats food ->
